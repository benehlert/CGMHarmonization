...
curr <- read_csv("RawData/Testing_Data/Buckingham2007/DirecNetNavigatorPilotStudy/DirecNetNavigatorPilotStudy/DataTables/tblFNavGlucose.csv")
...
Screening <- read_csv("RawData/Testing_Data/Buckingham2007/DirecNetNavigatorPilotStudy/DirecNetNavigatorPilotStudy/DataTables/tblFEnrollment.csv")

# Load the patient roster data to retrieve insulin modality and age at baseline.
Patient <- read_csv("RawData/Testing_Data/Buckingham2007/DirecNetNavigatorPilotStudy/DirecNetNavigatorPilotStudy/DataTables/tblFPtRoster.csv")
...
## Keep original subject IDs; return variable named `id`.
Output <- Output %>%  # Remove NA times and gl values
  ...
  ungroup() %>%
  select(id, time, gl, age, sex, insulinModality, type, device, dataset) # Reorder columns; keep original id
