...
filename <- "RawData/Training_Data/Hall2018/pbio.2005143.s010"
# If for some reason the filename has changed, simply set filename <- "newname"


# Load additional covariates from SQLite database
dbfile <- 'RawData/Training_Data/Hall2018/pbio.2005143.s014.db' # S5 Data from the study
...
df_final <- df %>%
  # Keep the original IDs from the data exactly as they are
  mutate(id = id,
