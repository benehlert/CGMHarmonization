...
# Working directory is set to CGMHarmonization
# setwd(dataset)  # Removed to keep working directory as CGMHarmonization

# This is the path to the CGM file in RawData directory
file.path <- "RawData/Testing_Data/Anderson2016/CTR3_Public_Dataset/Data Tables/CGM.txt"
