...
# Modified to work with RawData directory structure

# This study downloads as a folder containing a diabetes subset and a healthy subset
# The data is located in RawData/Dubosson2018/
# We'll process the diabetes subset which contains CGM data
dataset <- "Dubosson2018"

# This is the path to the CGM file folders with original names
file.path <- "RawData/Testing_Data/Dubosson2018/diabetes_subset_pictures-glucose-food-insulin/"
