...
# setwd(dataset)  # Removed since working directory should remain CGMHarmonization

# This is the relative path to the CGM files with original names
file.path <- paste("RawData/Testing_Data", dataset, "RT-CGM Randomized Clinical Trial", "DataTables", sep = "/")
